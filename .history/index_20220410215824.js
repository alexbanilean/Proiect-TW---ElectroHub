...
const obGlobal={obImagini:null, obErori:null, obImaginiGalerieAnimata:null};
...
app.get("*/galerie-animata.css", function(req,res){
    ...
    while(nrimg > 0){
        if(id <= obImagini.imagini.length){
            obImaginiGalerieAnimata.push(obImagini.imagini[id - 1]);
        }
...
app.get("*/galerie-animata", function(req,res){
    ...
    res.render("pagini/galerie-animata", {imagini: lista_imagini_galerie_animata, numar_imagini_aleator : numar_imagini_aleator});
});
