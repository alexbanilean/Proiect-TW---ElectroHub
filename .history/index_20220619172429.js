...
app.get("/produse/:categ?", function(req, res){
    client.query("select * from unnest(enum_range(null::categorie_produs))", function(err, rezCateg){
        ...
        var cond_where = req.params.categ ? "categorie=$2::text` : "1=1";
        let queryProd = `select * from produse where $1::text`;
        
        client.query(queryProd, [cond_where, req.params.categ],function(err, rezQuery){
            // console.log(rezQuery);
            if(!err)
