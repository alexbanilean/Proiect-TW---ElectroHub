...
app.use("/*", function(req, res, next){
    ...
    client.query("select * from unnest(enum_range(null::categorie_produs))", function(err, rezCateg){
        if(!err){
            ...
            res.locals.categorii_meniu = rezCateg.rows;
                ...
                if(rezUtiliz.rows.length != 0){
                    ...
                    client.query(comandaInserare, function(err, rezInserare){
                        if(err){
                            ...
                            trimiteMail(campuriText.email, "Te-ai inregistrat!", "Text", `<p style='color:blue'>Username-ul tau este ${username}.</p>
...
app.get("/cod/:usename/:token", function(req, res){
    var comandaUpdate = "update utilizatori set confirmat_mail = true where username = "
})
