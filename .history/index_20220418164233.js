            ...
            if(err)
                ...
                if(rezSelect.rows.length == 1){ // Daca am utilizatorul si a dat crediteantiale corecte
                    req.session.utilizator = {
                        nume : querySelect.rows[0].nume,
                        prenume : querySelect.rows[0].prenume,
                        username : querySelect.rows[0].username,
                        email : querySelect.rows[0].email,
                        culoare_chat : querySelect.rows[0].culoare_chat,
                        rol : 
                    }
                }
            }
