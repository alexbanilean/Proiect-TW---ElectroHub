...
async function trimiteMail(email, subiect, mesajText, mesajHtml, atasamente=[]){
    ...
    await transp.sendMail({
        ...
        html: mesajHtml, // `<h1>Salut!</h1><p style='color:blue'>Username-ul tau este ${username}.</p> <p><a href='http://${numeDomeniu}/cod/${username}/${token}'>Click aici pentru confirmare</a></p>`,        attachments: atasamente    
    })
