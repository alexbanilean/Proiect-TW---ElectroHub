...
app.use("/*", function(req, res, next){
    ...
    client.query("select * from enum_range(null::categorie_produs)", function(err, rezQuery){
        if(!err){
            console.log(rezQuery.rows.enum_range);
            res.locals.categorii_meniu = rezQuery.rows.enum_range;
        }
        else
