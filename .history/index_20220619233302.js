            ...
            client.query(queryUtiliz, [campuriText.username], function(err, rezUtiliz){
                if(rezUtiliz.rows.length != 0){
                    ...
                    var comandaInserare = `insert into utilizatori (username, nume, prenume, parola, email, data_adaugare,culoare_chat, cod) values 
                                            ($1, $2, $3, $4, $5, $6, $7)`;
                    client.query(comandaInserare, [campuriText.username, campuriText.nume, campuriText.prenume, parolaCriptata, campuriText.email, new(), campuriText.culoare_chat, token], function(err, rezInserare){
                        if(err){
                            console.log(err);
