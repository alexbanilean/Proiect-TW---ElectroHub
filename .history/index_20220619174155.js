...
app.get("/cod/:username/:token", function(req, res){
    ...
    if(current_date - user_date <= 10 * 60 * 1000){
        var comandaUpdate = `update utilizatori set confirmat_mail = true where username = '${}' and cod = '${req.params.token}'`;
        client.query(comandaUpdate, [req.params.username, ], function(err, rezUpdate){
            if(err){
                console.log("err");
