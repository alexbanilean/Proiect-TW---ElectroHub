...
window.onload = function(){
    ...
    document.getElementById("stergere").onclick = function(){
        document.body.lastElementChild.remove();
    }

    var b_data = document.getElementById("creeaza");
    b_data.onclick = function(){
        var p = document.createElement("p");
        p.innerHTML = toString(new Date().getDate();
        document.body.appendChild(p);
    }
}
// alert(2);