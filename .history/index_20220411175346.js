...
app.post("/inregistare", function(req, res){
    ...
    formular.parse(req, function(err, campuriText, campuriFisier){
        ...
        var comandaInserare = `insert into utilizatori (username, nume, prenume, parola, email, culoare_chat) values 
                                ('${campuriText.username}', '${campuriText.nume}', '${campuriText.prenume}', '${parolaCriptata}', '${campuriText.email}', '${campuriText.culaore_chat}')`;
        client.query(comandaInserare)                                
        res.send("OK");
    });
})
