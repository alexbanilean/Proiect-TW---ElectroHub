...
var client = new Client({user:"alex_test", password: "alex_test", database: "ElectroHub", host: "localhost", port: 5432});
...
app.get(["/", "/index", "/home"], function(req, res){
    ...
    client.query("select * from tabel_test", function(err, rezQuery){
        ...
        if(!err)
            res.render("pagini/index", {ip: req.ip, imagini: obImagini.imagini, produse: rezQuery});
    })
})
