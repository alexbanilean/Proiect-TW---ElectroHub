 ...
 window.addEventListener("load", function(){
     ...
     document.getElementById("filtrare").onclick = function(){
        ...
        for(let art of articole){
            ...
            let cond3=(valPretMin <= pretArt && pretArt <= valPretMax);

            console.log(valPretMin, valPretMax, pretArt);
            ...
            let conditieFinala = (cond1 && cond3 && cond4);
